...
class App {
    ...
    _newWorkout(e) {
        ...
        if (type === "running") {
            ...
            if (!validInputs(distance, duration, cadence) || !allPositive(distance, duration, cadence)) return alert("Inputs have to be postitive numbers!");
            workout = new Running([
                lat,
                lng
        ...
        if (type === "cycling") {
            ...
            if (!validInputs(distance, duration, elevation) || !allPositive(distance, duration)) return alert("Inputs have to be postitive numbers!");
            workout = new Cycling([
                lat,
                lng
...
//# sourceMappingURL=index.1087fd21.js.map
